"""
Django settings for simple_ecom project.
...
env_vars = {
    ...
    **dotenv_values("../config/.secrets.env"),
    **os.environ,
}
...
SECRET_KEY = env_vars.get(
    "SECRET_KEY", "django-insecure-_--(zu+=%ch7scz-l184rjl9zzcr3t+(tnm2x3r2od*-&0(#g4"
)
...
WSGI_APPLICATION = "simple_ecom.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "HOST": env_vars.get("POSTGRES_HOST") if not DEBUG else "localhost",
